...
def train(cfg, local_rank, distributed, tblogger=None, transfer_weight=False, adjust_lr=False, skip_val=False,
    ...
    val_after = cfg.SOLVER.EVAL_AFTER * iter_per_epoch  #训练3轮验证1轮
    val_period = cfg.SOLVER.EVAL_PERIOD * iter_per_epoch

    mem_active = cfg.MODEL.STM.MEM_ACTIVE   #false
    frozen_backbone_bn = ('vit' not in cfg.MODEL.BACKBONE.CONV_BODY.lower()) and cfg.MODEL.BACKBONE.FROZEN_BN#false
